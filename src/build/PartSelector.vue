...
const selectNextPart =()=>{
      selectedPartIndex.value = getNextValidIndex( selectedPartIndex.value,  parts.length);
    };

    const selectPreviousPart=()=> {
       selectedPartIndex.value = getPreviousValidIndex( selectedPartIndex.value,parts.length    );
    }; 
</script>
